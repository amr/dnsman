...
/**
 * @class Ext.ux.ParkingFileTreeMenu
 * @extends Ext.menu.Menu
 * @constructor
 * Creates new ParkingFileTreeMenu object
 * @param {Object} config A configuration object
 */
Ext.ux.ParkingFileTreeMenu = function(config) {
	config = config || {};
	...
	// call parent
	Ext.ux.ParkingFileTreeMenu.superclass.constructor.call(this, config);
...
Ext.extend(Ext.ux.ParkingFileTreeMenu, Ext.menu.Menu, {
...
// register xtype
Ext.reg('filetreemenu', Ext.ux.ParkingFileTreeMenu);
