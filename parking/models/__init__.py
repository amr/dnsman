...
class ParkingPage(models.Model):
    ...
    template = models.TextField(help_text='Edit the parking page XHTML template right in the browser')
    ...
    resources_dir = DirectoryPathField(path=settings.PARKING_PAGES_DIR, null=True, blank=True, help_text="The directory which contains the external resources for the page, such as CSS and Images. To add a directory, you need to place it under %s" % settings.PARKING_PAGES_DIR)
